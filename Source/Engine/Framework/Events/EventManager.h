...
#define EVENT_SUBSCRIBE(id, function) umbra::EventManager::Instance().Subscribe(id, this, std::bind(&function, this, std::placeholders::_1));
#define EVENT_UNSUBSCRIBE(id) umbra::EventManager::Instance().Unsubscribe(id, this);
