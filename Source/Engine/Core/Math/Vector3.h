...
namespace umbra
{
	...
	public:
		...
		Vector3 operator - () { return Vector3(-x, -y, -z); } //flips the thing
		Vector3 Negate() const { return Vector3(-x, -y, -z); } //does the same thing the operator does lol
		...
		Vector3 Normalized() const { return *this / Length(); } //returns normalized value of our vector
